...
# all the configuration parameters are stored in this file
import copy_artifacts_config as config
...
def copy_intermediate_and_proxy(tagScrid,tagEnv):
    ...
    intermediate_dest = config.NON_PROD_BASE_DIR+tagEnv+"/ingest/video/intermediate/"
    check_directory_exists(intermediate_dest)
    proxy_dest = config.NON_PROD_BASE_DIR+tagEnv+"/ingest/video/frame-accurate-proxy/"
